  ...
  return (
    <>
      ...
      <div className="pe-l4 absolute z-10 h-screen w-screen overflow-hidden">
        ...
        <Mountains className="absolute h-2/3 bottom-80 left-1/6"></Mountains>
      </div>
